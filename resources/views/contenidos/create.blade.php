...
<div class="contnotis">
    ...
    <p><strong>Año:</strong> {{ $materia->curso->anio }} - <strong>División:</strong> {{ $materia->curso->division }}</p>

    <hr>

    <h1>Nuevo comunicado para {{ $materia->nombre }}</h1>
    <form action="{{ route('contenidos.store', $materia->id) }}" method="POST">
        @csrf
        <div class="notis">
