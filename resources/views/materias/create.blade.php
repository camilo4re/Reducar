...
<ul class="clases">
    ...
    <div class="titulo-caja">
        ...
        <input class="inputt" type="text" name="nombre" id="nombre" required>
    </div>
        <div class="titulo-caja">
        <label for="curso_id">Curso:</label>
        <select class="filtro-cursos" name="curso_id" id="curso_id" required>
        ...
        <div class="accioness">
            <button class="boton derechaa" type="submit">Crear materia</button>
        </div>
    </div>
<!-- Agregar después del select de curso_id -->
    ...
    <div class="titulo-caja">
        <label>Horarios de clase:</label>
                <select class="filtro-cursos" name="horarios[0][dia_semana]" required>
