...
<<<<<<< HEAD
        <!-- Información Personal -->
            <div class="info-personal">
                <div class="info-card">
                    <div class="info-titulo">{{ auth()->user()->name }}</div>
=======
...
<<<<<<< HEAD
        ...
        <!-- Resumen Principal -->
                <div class="resumen-general">
                    ...
                    <ul class="resumen-grid mi-reporte">
                        <li class="cajas stat-card stat-asistencia-principal">
                ...
                <div class="estado-asistencia-container">
                ...
                <div class="detalle-asistencia">
                    ...
                    <div class="tabla-asistencias">
                        <table class="tabla-detalle-personal">
                            <thead>
                                <tr>
                                    <th>Concepto</th>
                                    <th>Cantidad</th>
        ...
        @else
            <div class="sin-datos-container">
                <div class="contnotis">
                    <div class="notis sin-datos-alumno">
